...
if (!class_exists('ssl_zen_helper')) {
    ...
    class ssl_zen_helper
    {
        ...
        /**
         * A patch to use LE's old CAbundle file
         *
         * @since 3.2.4
         * @static
         */
        public static function copyCaBundle() {
            if (file_exists(SSL_ZEN_DIR . 'cabundle/cabundle.crt')) {
                @rename(SSL_ZEN_DIR . 'cabundle/cabundle.crt', SSL_ZEN_DIR . 'keys/cabundle.crt');
            }
            if (file_exists(SSL_ZEN_DIR . 'cabundle/cabundle.txt')) {
                @rename(SSL_ZEN_DIR . 'cabundle/cabundle.txt', SSL_ZEN_DIR . 'keys/cabundle.txt');
            }
        }
